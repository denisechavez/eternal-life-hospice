...
def make_footer(county: str) -> str:
    ...
    return (
        ...
        '</svg><span>805.953.7273 \u00b7 Main</span></a>'
        '<a class="fc-line fc-direct" href="tel:18052954688">'
        '<svg class="fci" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">'
        '<path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.13.96.36 1.9.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.91.34 1.85.57 2.81.7A2 2 0 0 1 22 16.92z"/>'
        '</svg><span>805.295.4688 \u00b7 Direct</span></a>\n'
        ...
        '<circle cx="12" cy="10" r="3"/>'
         '</svg><span>4165 E Thousand Oaks Blvd, Ste 325B<br>Westlake Village, CA 91362</span></span>\n'
