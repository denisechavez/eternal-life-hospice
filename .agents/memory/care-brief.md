...
- Editorial tradition (user decision): every volume's cover features a person who "introduces" the issue — portrait + "Introduced by" in the plum band. Volume One = Aleksandra Dubina (founder). Pick the introducer when planning each new issue.
